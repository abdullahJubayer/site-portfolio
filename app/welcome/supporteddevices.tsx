...
export const SupportedDevices: React.FC = () => {
  return (
    <div className="flex justify-between gap-24 items-center bg-gray-100 text-black px-28 py-16 my-24">
      <div className="">
        <h1 className="text-6xl font-bold">Available on all your devices</h1>
